 ...
 * @author Home
 */
public class SwingJanela extends javax.swing.JFrame {

    /**
     * Creates new form SwingJanela
     */
    public SwingJanela() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SwingJanela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SwingJanela().setVisible(true);
            }
        });
    }
